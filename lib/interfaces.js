 ...
 *
 * This uses the `connect` method which obtains the client and sets up the connection.
 * The driver should emit 'connect' and 'disconnect' events in order to leverage the reconnect facility.
 *
 * @param {function():Q} connect
 *      Connecter function that returns a new database client (promised)
 *
 * @property {function():Q} connect
 *      Connecter function
 * @property {*} client
 *      The DB client
 ...
 *
 * @event {IMissyDriver#connect} (IMissyDriver)
 *      DB client connected
 * @event {IMissyDriver#disconnect} (IMissyDriver)
