...
Model.prototype.find = function(criteria, fields, sort, options){
    ...
    options.skip = Math.min( parseInt(ctx.options.skip) || 0, 0);
    options.limit = Math.min( parseInt(ctx.options.limit) || 0, 0);
    ...
    return Q()
        ...
        .then(function(entities){
            ...
            return Q.all(_.map(ctx.entities, self.entityLoading.bind(self)));
        })
        // afterFind
        .then(function(){
            return self.hooks.afterFind(ctx.entities, ctx);
        })
        // return
        .get(0);
};
...
Model.prototype.insert = function(entities, options){
    ...
    return Q()
        ...
        // beforeInsert
        .then(function(){
            return self.hooks.beforeInsert(ctx.entities, ctx);
        })
        // insert
        .then(function(){
            return self.driver.insert(self, ctx.entities, ctx.options);
        })
        // entityLoading
        .then(function(entities){
            ctx.entities = entities;
        ...
        // afterInsert
        .then(function(){
            return self.hooks.afterInsert(ctx.entities, ctx);
        })
        // return
        .get(0);
};
...
Model.prototype.update = function(entities, options){
    ...
    return Q()
        ...
        // beforeUpdate
        .then(function(){
            return self.hooks.beforeUpdate(ctx.entities, ctx);
        })
        // update
        .then(function(){
            return self.driver.update(self, ctx.entities, ctx.options);
        })
        // entityLoading
        .then(function(entities){
            ctx.entities = entities;
        ...
        // afterUpdate
        .then(function(){
            return self.hooks.afterUpdate(ctx.entities, ctx);
        })
        // return
        .get(0);
};
...
Model.prototype.save = function(entities, options){
    ...
    return Q()
        ...
        // beforeSave
        .then(function(){
            return self.hooks.beforeSave(ctx.entities, ctx);
        })
        // save
        .then(function(){
            return self.driver.save(self, ctx.entities, ctx.options);
        })
        // entityLoading
        .then(function(entities){
            ctx.entities = entities;
        ...
        // afterSave
        .then(function(){
            return self.hooks.afterSave(ctx.entities, ctx);
        })
        // return
        .get(0);
};
...
Model.prototype.remove = function(entities, options){
    ...
    return Q()
        ...
        // beforeRemove
        .then(function(){
            return self.hooks.beforeRemove(ctx.entities, ctx);
        })
        // remove
        .then(function(){
            return self.driver.remove(self, ctx.entities, ctx.options);
        })
        // entityLoading
        .then(function(entities){
            ctx.entities = entities;
        ...
        // afterRemove
        .then(function(){
            return self.hooks.afterRemove(ctx.entities, ctx);
        })
        // return
        .get(0);
};
