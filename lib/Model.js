...
Model.prototype.findOne = function(criteria, fields, sort, options){
    ...
    return Q()
        ...
        // findOne
        .then(function(){
            return self.driver.findOne(ctx.criteria, ctx.fields, ctx.sort, ctx.options)
        })
        // entityLoading
        .then(function(entity){
...
Model.prototype.find = function(criteria, fields, sort, options){
    ...
    return Q()
        ...
        // find
        .then(function(){
            return self.driver.find(ctx.criteria, ctx.fields, ctx.sort, ctx.options);
        })
        // entityLoading
        .then(function(entity){
            return self.entityLoading(entity);
...
Model.prototype.count = function(criteria, options){
    ...
    return self.driver.count(ctx.criteria, ctx.options); // -> count
};
...
Model.prototype.insert = function(entity, options){
    ...
    return Q()
        ...
        // insert
        .then(function(){
            return self.driver.insert(entity, ctx.options);
        })
        // entityLoading
        .then(function(entity){
            return self.entitySaving(entity);
...
Model.prototype.update = function(entity, options){
    ...
    return Q()
        ...
        // update
        .then(function(){
            return self.driver.update(entity, ctx.options);
        })
        // entityLoading
        .then(function(entity){
            return self.entityLoading(entity);
...
Model.prototype.save = function(entity, options){
    ...
    return Q()
        ...
        // save
        .then(function(){
            return self.driver.save(entity, ctx.options);
        })
        // entityLoading
        .then(function(entity){
            return self.entityLoading(entity);
...
Model.prototype.remove = function(entity, options){
    ...
    return Q()
        ...
        // remove
        .then(function(){
            return self.driver.remove(entity, ctx.options);
        })
        // entityLoading
        .then(function(entity){
            return self.entityLoading(entity);
